...
public sealed class Palette
{
    ...
    /// <summary>
    /// Размытие под нижней частью раскрытого острова. Пока не работает.
    /// </summary>
    /// <remarks>
    /// Жидкого стекла в Windows нет, ближайшее — акрил. Но включается он на
    /// всё окно целиком, а окно у нас прозрачное и во всю ширину экрана:
    /// вместо острова получался чёрный прямоугольник. Правильный путь —
    /// отдельное окно с размытием под фигурой острова, и это отдельная
    /// работа. До тех пор остров просто плотный.
    /// </remarks>
